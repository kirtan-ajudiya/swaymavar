...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $generalsetting->phone_one = $request->phone_one;
        $generalsetting->whatsapp_number_one = $request->whatsapp_number_one;
        ...
        $generalsetting->linkdin = $request->linkdin;
        $generalsetting->gst_no = $request->gst_no;
