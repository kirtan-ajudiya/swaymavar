...
class SubSubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('banner')){
            $subsubcategory->sub_sub_banner = $request->file('banner')->store('uploads/subsubcategories/banner');
        }
        if($request->hasFile('icon')){
            $subsubcategory->sub_sub_icon = $request->file('icon')->store('uploads/subsubcategories/icon');
        }
