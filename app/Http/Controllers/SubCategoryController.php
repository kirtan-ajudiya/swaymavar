...
class SubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('icon')){
            $subcategory->sub_icon = $request->file('icon')->store('uploads/subcategories/icon');
        }
    ...
    public function update(Request $request, $id)
    {
       ...
       if($request->hasFile('banner')){
            $subcategory->sub_banner = $request->file('banner')->store('uploads/subcategories/banner');
        }
        if($request->hasFile('icon')){
            $subcategory->sub_icon = $request->file('icon')->store('uploads/subcategories/icon');
        }
    ...
    public function get_subcategories_by_category(Request $request)
    {
        ...
        //     return response()->json(['status'=>true, 'cat'=>$subcategories]);
        // }else{
        //     $subcategories = Product::where('category_id', $request->category_id)->get();
        //     return response()->json(['status'=>false, 'cat'=>$subcategories]);
        // }
        // // $subcategories = Product::where('category_id', $request->category_id)->get();
        // //     return response()->json(['status'=>false, 'cat'=>$subcategories]);
