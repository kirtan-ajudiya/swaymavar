            ...
            <tbody>
                @foreach($subcategories as $key => $subcategory)
                    <tr>
                        ...
                        <td><img loading="lazy"  class="img-md" src="{{ asset($subcategory->sub_banner) }}" alt="{{__('banner')}}"></td>
                        <td><img loading="lazy"  class="img-xs" src="{{ asset($subcategory->sub_icon) }}" alt="{{__('icon')}}"></td>
                        <td>
