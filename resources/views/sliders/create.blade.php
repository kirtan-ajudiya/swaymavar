<div class="panel">
    ...
    <form class="form-horizontal" action="{{ route('sliders.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            ...
            <!-- <div class="form-group">
                <label class="col-sm-3" for="url">{{__('Text 1')}}</label>
                <div class="col-sm-9">
                    <input type="text" id="url" name="text_one" placeholder="Enter text" class="form-control" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3" for="url">{{__('Text 2')}}</label>
                <div class="col-sm-9">
                    <input type="text" id="url" name="text_two" placeholder="Enter text" class="form-control" required>
                </div>
            </div> -->
        </div>
