...
<!-- 
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('Nimbbl Credential')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    @csrf
                    <input type="hidden" name="payment_method" value="nimbbl">
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="NIMBBL_KEY">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('NIMBBL KEY')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="NIMBBL_KEY" value="{{  env('NIMBBL_KEY') }}" placeholder="NIMBBL KEY" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="NIMBBL_SECRET">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('NIMBBL SECRET')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="NIMBBL_SECRET" value="{{  env('NIMBBL_SECRET') }}" placeholder="NIMBBL SECRET" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-12 text-right">
