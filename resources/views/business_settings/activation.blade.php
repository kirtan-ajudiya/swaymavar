...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ asset('frontend/images/rozarpay.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('Nimbbl Pay Activation')}}</h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ asset('frontend/images/rozarpay.png') }}" height="30">
                    <label class="switch pull-right">
                        <input type="checkbox" onchange="updateSettings(this, 'nimbbl')" <?php if(\App\BusinessSetting::where('type', 'nimbbl')->first()->value == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ asset('frontend/images/cod.png') }}" height="30">
                    <label class="switch pull-right">
