            ...
            <tbody>
                @foreach($customers as $key => $customer)
                    <tr>
                        ...
                        <td>{{ (!empty($customer->user))?$customer->user->name:''}}</td>
                        <td>{{(!empty($customer->user))?$customer->user->email:''}}</td>
                        <td>{{(!empty($customer->user))?$customer->user->phone:''}}</td>
                        <!-- <td>
                            @if (!empty($customer->user) && $customer->user->customer_package != null)
                                {{$customer->user->customer_package->name}}
                            @endif
                        </td>
                        <td>{{(!empty($customer->user))?single_price($customer->user->balance):''}}</td> -->
                        <td>
