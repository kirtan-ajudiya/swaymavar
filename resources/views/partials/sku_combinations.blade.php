	...
	@if(strlen($str) > 0)
			<tr>
				<td>
					...
					<input type="number" name="choice_options_2[]" id="size_{{ $str }}" value="{{ $str }}" onkeyup="getVarient({{ $str }})" min="0" step="0.01" class="form-control" required>
				</td>
				<td>
					<input type="number" name="choice_options_price[]" id="price_{{ $str }}" readOnly value="{{ $unit_price*$str }}" min="0" step="0.01" class="form-control" required>
				</td>
				 <td>
