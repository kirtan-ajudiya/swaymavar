            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <select class="form-control demo-select2"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                        <option value="pending" @if ($delivery_status == 'pending') selected @endif>{{__('Packing')}}</option>
                        <option value="on_review" @if ($delivery_status == 'on_review') selected @endif>{{__('Dispatching')}}</option>
                        ...
                        <option value="canceled" @if ($delivery_status == 'canceled') selected @endif>{{__('Canceled')}}</option>
                    </select>
                </div>
            </div>
            <hr>
