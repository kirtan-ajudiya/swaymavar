@extends('frontend.customer.inc.sidenav')
    ...
    <div class="col lg-9 md-12 no-margin-bottom padding-top-bottom-double">
        ...
        <div class="container container-nested is-wrapping">
            ...
            <div class="col lg-4 md-4 sm-12 no-margin-bottom">
                <div class="input-set-group">
                    ...
                    <input type="text" id="postcode_zip" name="postal_code" placeholder="Enter Postcode / ZIP" />
                    @error('postal_code')
                        <div style="color: red">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col lg-4 md-4 sm-12 no-margin-bottom">
                <div class="input-set-group">
                    ...
                    <input type="text" id="town_city" name="city" placeholder="Enter Town / City" />
                    @error('city')
                        <div style="color: red">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col lg-4 md-4 sm-12 no-margin-bottom">
                <div class="input-set-group">
                    <label class="fw-500" for="province_state">Province / State&nbsp;<span
                            class="required">*</span></label>
                    <input type="text" id="province_state" name="state" placeholder="Enter Postcode / ZIP" />
                    @error('state')
                        <div style="color: red">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col lg-4 md-4 sm-12 no-margin-bottom">
                <div class="input-set-group">
                    ...
                    <input type="text" id="email_address" name="email"  placeholder="Enter Email address" />
                    @error('email')
                        <div style="color: red">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <button type="submit" class="inline-button" style="width: auto !important;">Save Address</button>
    </div>
</form>
@endsection
