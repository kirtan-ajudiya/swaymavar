                                        ...
                                        <div class="product-box-2 bg-white alt-box my-2">
                                            <div class="position-relative overflow-hidden">
                                                <a href="{{ route('product', $product->slug) }}" class="d-block product-image h-100 text-center">
                                                    ...
                                                    <div class="tag" style="float: left;position: absolute;left: 0px;top: 0px;background-color: #92AD40;padding: 5px;color: #FFFFFF;font-weight: bold;">@if($product->discount_type == "amount") Rs{{$product->discount}} OFF @else {{$product->discount}}% OFF @endif</div>
                                                    @endif
