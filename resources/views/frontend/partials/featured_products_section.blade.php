                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="card-image">
                                    <a href="{{ route('product', $product->slug) }}" class="d-block">
                                        ...
                                        <div class="tag" style="float: left;position: absolute;left: 0px;top: 0px;z-index: 1000;background-color: #92AD40;padding: 5px;color: #FFFFFF;font-weight: bold;">@if($product->discount_type == "amount") Rs{{$product->discount}} OFF @else {{$product->discount}}% OFF @endif</div>
                                        @endif
