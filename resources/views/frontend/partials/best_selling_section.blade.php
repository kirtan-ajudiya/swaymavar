                                    ...
                                    <div class="col-4">
                                        <div class="position-relative overflow-hidden h-100">
                                            <a href="{{ route('product', $product->slug) }}" class="d-block product-image h-100">
                                                ...
                                                <div class="tag" style="float: left;position: absolute;left: 0px;top: 0px;z-index: 1000;background-color: #92AD40;padding: 3px;color: #FFFFFF;font-weight: bold;">@if($product->discount_type == "amount") Rs{{$product->discount}} OFF @else {{$product->discount}}% OFF @endif</div>
                                                @endif
