                      ...
                      <div class="table-responsive">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                              ...
                              <td>{{ $detailedProduct->colorss->color }}</td>
                        ...
                        <table class="table table-sm">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              {{ $detailedProduct->metal_rate }}/g <br> @if($detailedProduct->diamond_price !="") {{ $detailedProduct->diamond_price }}/g @else - @endif <br>
                                @if($detailedProduct->choki_diamond_price !="") {{ $detailedProduct->choki_diamond_price }}/g @else - @endif <br>
                                @if($detailedProduct->solited_diamond_price !="") {{ $detailedProduct->solited_diamond_price }}/g @else - @endif

                              </td>

                              <td>{{ $detailedProduct->metal_weight }} g  <br> @if($detailedProduct->diamond_weight !="") {{ $detailedProduct->diamond_weight }}/g @else - @endif <br>
                                @if($detailedProduct->choki_diamond_weight !="") {{ $detailedProduct->choki_diamond_weight }} g @else - @endif <br>
                                @if($detailedProduct->solited_diamond_weight !="") {{ $detailedProduct->solited_diamond_weight }} g @else - @endif
                              </td>
