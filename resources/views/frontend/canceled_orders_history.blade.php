                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('purchase_history.cancel_purchase_history') }}">{{__('Canceled Order History')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($orders as $key => $order)
                                                <tr>
                                                    ...
                                                    <td style="color: red">
                                                        @php
                                                           if(isset($order->delivery_status) && $order->delivery_status != ""){
