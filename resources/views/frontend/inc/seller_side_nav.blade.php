    ...
    <div class="widget mb-0">
        ...
        <div class="widget-profile-menu py-3">
            <ul class="categories categories--style-3">
                ...
                <li>
                    <a href="{{ route('purchase_history.cancel_purchase_history') }}" class="{{ areActiveRoutesHome(['purchase_history.cancel_purchase_history'])}}">
                        <i class="la la-file-text"></i>
                        <span class="category-name">
                            {{__('Canceled Order History')}}
                        </span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('orders.seller_canceled_order') }}" class="{{ areActiveRoutesHome(['orders.seller_canceled_order'])}}">
                        <i class="la la-file-text"></i>
                        <span class="category-name">
                            {{__('Canceled Orders')}} 
                        </span>
