    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-content">
            ...
            <ul class="nav navbar-top-links">
                ...
                $contacts = App\Contact::where('view', 1)->count();
                @endphp
{{-- 
                ...
                <li class="dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true">
                        ...
                        @if($orders > 0 || $sellers > 0 || $contacts > 0)
                        ...
                        <div class="nano scrollable has-scrollbar" style="height: 265px;">
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                <ul class="head-list">
                                    ...
                                    @if($contacts > 0)
                                        <li>
                                            <a class="media" href="{{ route('contacts.index') }}" style="position:relative">
                                                <span class="badge badge-header badge-info" style="right:auto;left:3px;"></span>
                                                <div class="media-body">
                                                    <p class="mar-no text-nowrap text-main text-semibold">{{ $contacts }} new contact(s)</p>
                                                </div>
                                            </a>
                                        </li>
                                    @endif
